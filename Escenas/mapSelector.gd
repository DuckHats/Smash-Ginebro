...
onready var character_select_vars = get_node("res://Escenas/CharacterSelector.tscn")

onready var selected1 = get_node("SelectedChar1")
onready var selected2 = get_node("SelectedChar2")
